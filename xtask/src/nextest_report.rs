...
fn profile_to_command(profile_name: &str) -> String {
    ...
    match profile_name {
        ...
        "ci-mock-res" => "cargo nextest run --no-fail-fast -E test(resiliency::fault_injection::) --features mock,res-fi --package azihsm_api_tests --profile ci-mock-res".to_string(),
        "ci-mock-table-4" => {
