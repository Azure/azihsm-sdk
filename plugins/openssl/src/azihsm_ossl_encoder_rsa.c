...
static int azihsm_ossl_encoder_encode(AIHSM_ENCODER_CTX* ctx, OSSL_CORE_BIO* out, const AZIHSM_RSA_KEY* rsa_key,
...
static int azihsm_ossl_encoder_der_spki_encode(AIHSM_ENCODER_CTX* ctx, OSSL_CORE_BIO* out, ossl_unused const AZIHSM_RSA_KEY* rsa_key,
                                              ossl_unused const OSSL_PARAM key_abstract[], ossl_unused int selection,
                                              ossl_unused OSSL_PASSPHRASE_CALLBACK* cb, ossl_unused void* cbarg)
{
    BIO* bio;
