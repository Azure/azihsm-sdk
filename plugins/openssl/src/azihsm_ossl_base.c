...
static const OSSL_ALGORITHM azihsm_ossl_rand[] = {
    ALG_TABLE_END};
...
static const OSSL_ALGORITHM *azihsm_ossl_query_operation(ossl_unused void *provctx, int operation_id, int *no_store)
{
...
static OSSL_STATUS azihsm_ossl_get_capabilities(ossl_unused void *provctx, ossl_unused const char *capability,
                                                  ossl_unused OSSL_CALLBACK *cb, ossl_unused void *arg)
{
    return OSSL_FAILURE;
}
...
OSSL_STATUS OSSL_provider_init(const OSSL_CORE_HANDLE *handle,
