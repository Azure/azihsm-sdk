...
static int azihsm_ossl_cipher_encrypt_init(ossl_unused void *cctx, ossl_unused const unsigned char *key,
                                          ossl_unused size_t keylen, ossl_unused const unsigned char *iv,
                                          ossl_unused size_t ivlen, ossl_unused const OSSL_PARAM params[])
{
    // TODO: Initialize encryption
    return 0;
}

static int azihsm_ossl_cipher_decrypt_init(ossl_unused void *cctx, ossl_unused const unsigned char *key,
                                          ossl_unused size_t keylen, ossl_unused const unsigned char *iv,
                                          ossl_unused size_t ivlen, ossl_unused const OSSL_PARAM params[])
{
...
static int azihsm_ossl_cipher_update(ossl_unused void *cctx, ossl_unused unsigned char *out, ossl_unused size_t *outl,
                                    ossl_unused size_t outsize, ossl_unused const unsigned char *in, ossl_unused size_t inl)
{
    // TODO: Process cipher update
    return 0;
}

static int azihsm_ossl_cipher_final(ossl_unused void *cctx, ossl_unused unsigned char *out,
...
static int azihsm_ossl_cipher_cipher(ossl_unused void *cctx, ossl_unused unsigned char *out, ossl_unused size_t *outl,
                                    ossl_unused size_t outsize, ossl_unused const unsigned char *in, ossl_unused size_t inl)
{
...
static int azihsm_ossl_cipher_get_params(OSSL_PARAM params[], unsigned int mode, size_t keylen,
                                        size_t blksize, size_t ivlen, ossl_unused unsigned long flags)
{
    OSSL_PARAM *p = NULL;
...
static int azihsm_ossl_cipher_get_ctx_params(ossl_unused void *cctx, ossl_unused OSSL_PARAM params[])
{
    // TODO: Get cipher context parameters
    return 0;
}

static int azihsm_ossl_cipher_set_ctx_params(ossl_unused void *cctx, ossl_unused const OSSL_PARAM params[])
{
...
static const OSSL_PARAM *azihsm_ossl_cipher_gettable_ctx_params(ossl_unused void *cctx, ossl_unused void *provctx)
{
    static const OSSL_PARAM params[] = {
        OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_KEYLEN, NULL),
        OSSL_PARAM_size_t(OSSL_CIPHER_PARAM_IVLEN, NULL),
...
static const OSSL_PARAM *azihsm_ossl_cipher_settable_ctx_params(ossl_unused void *cctx, ossl_unused void *provctx)
{
    static const OSSL_PARAM params[] = {
...
#define IMPLEMENT_AZIHSM_OSSL_CIPHER(alg)                                                                  \
    ...
    {OSSL_FUNC_CIPHER_GETTABLE_CTX_PARAMS, (void (*)(void))azihsm_ossl_cipher_gettable_ctx_params},        \
    {OSSL_FUNC_CIPHER_SETTABLE_CTX_PARAMS, (void (*)(void))azihsm_ossl_cipher_settable_ctx_params},        \
    {0, NULL}};
