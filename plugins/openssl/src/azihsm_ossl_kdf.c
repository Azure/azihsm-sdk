...
static int azihsm_ossl_kdf_derive(ossl_unused void *kctx, ossl_unused unsigned char *key,
...
static int azihsm_ossl_kdf_set_ctx_params(ossl_unused void *kctx, ossl_unused const OSSL_PARAM params[])
{
...
static const OSSL_PARAM *azihsm_ossl_kdf_gettable_ctx_params(ossl_unused void *kctx, ossl_unused void *provctx)
{
    static const OSSL_PARAM params[] = {
...
static const OSSL_PARAM *azihsm_ossl_kdf_settable_ctx_params(ossl_unused void *kctx, ossl_unused void *provctx)
{
    static const OSSL_PARAM params[] = {
