...
static int azihsm_ossl_signature_sign_init(
    ossl_unused void *sctx,
...
static int azihsm_ossl_signature_sign(
    ossl_unused void *sctx,
    ossl_unused unsigned char *sig,
    ossl_unused size_t *siglen,
    ossl_unused size_t sigsize,
    ossl_unused const unsigned char *tbs,
...
static int azihsm_ossl_signature_verify_init(
    ossl_unused void *sctx,
    ossl_unused void *provkey,
    ossl_unused const OSSL_PARAM params[]
)
...
static int azihsm_ossl_signature_verify(
    ossl_unused void *sctx,
    ossl_unused const unsigned char *sig,
    ossl_unused size_t siglen,
    ossl_unused const unsigned char *tbs,
    ossl_unused size_t tbslen
)
...
static int azihsm_ossl_signature_digest_sign_init(
    ossl_unused void *sctx,
    ossl_unused const char *mdname,
    ossl_unused void *provkey,
    ossl_unused const OSSL_PARAM params[]
)
{
...
static int azihsm_ossl_signature_digest_sign_update(
    ossl_unused void *sctx,
    ossl_unused const unsigned char *data,
...
static int azihsm_ossl_signature_digest_sign_final(
    ossl_unused void *sctx,
    ossl_unused unsigned char *sig,
    ossl_unused size_t *siglen,
    ossl_unused size_t sigsize
...
static int azihsm_ossl_signature_digest_verify_init(
    ossl_unused void *sctx,
    ossl_unused const char *mdname,
    ossl_unused void *provkey,
    ossl_unused const OSSL_PARAM params[]
...
static int azihsm_ossl_signature_digest_verify_update(
    ossl_unused void *sctx,
    ossl_unused const unsigned char *data,
    ossl_unused size_t datalen
)
...
static int azihsm_ossl_signature_digest_verify_final(
    ossl_unused void *sctx,
    ossl_unused const unsigned char *sig,
    ossl_unused size_t siglen
)
...
static int azihsm_ossl_signature_get_ctx_params(
    ossl_unused void *sctx,
...
static int azihsm_ossl_signature_set_ctx_params(
    ossl_unused void *sctx,
    ossl_unused const OSSL_PARAM params[]
)
{
...
static const OSSL_PARAM *azihsm_ossl_signature_gettable_ctx_params(
    ossl_unused void *sctx,
...
static const OSSL_PARAM *azihsm_ossl_signature_settable_ctx_params(
    ossl_unused void *sctx,
    ossl_unused void *provctx
)
{
...
const OSSL_DISPATCH azihsm_ossl_rsa_signature_functions[] = {
    ...
    { OSSL_FUNC_SIGNATURE_DIGEST_SIGN_INIT,
      (void (*)(void))azihsm_ossl_signature_digest_sign_init },
    { OSSL_FUNC_SIGNATURE_DIGEST_SIGN_UPDATE,
      (void (*)(void))azihsm_ossl_signature_digest_sign_update },
    { OSSL_FUNC_SIGNATURE_DIGEST_SIGN_FINAL,
      (void (*)(void))azihsm_ossl_signature_digest_sign_final },
    { OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_INIT,
      (void (*)(void))azihsm_ossl_signature_digest_verify_init },
    { OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_UPDATE,
      (void (*)(void))azihsm_ossl_signature_digest_verify_update },
    { OSSL_FUNC_SIGNATURE_DIGEST_VERIFY_FINAL,
      (void (*)(void))azihsm_ossl_signature_digest_verify_final },
    ...
    { OSSL_FUNC_SIGNATURE_GETTABLE_CTX_PARAMS,
      (void (*)(void))azihsm_ossl_signature_gettable_ctx_params },
    { OSSL_FUNC_SIGNATURE_SETTABLE_CTX_PARAMS,
      (void (*)(void))azihsm_ossl_signature_settable_ctx_params },
    { 0, NULL }
};
