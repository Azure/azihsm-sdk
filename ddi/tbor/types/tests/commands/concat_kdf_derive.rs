...
#[test]
fn concat_kdf_var_hmac256_min_length_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_var_hmac256_max_length_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_var_hmac256_below_min_length_rejected_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_var_hmac256_above_max_length_rejected_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_unknown_scope_rejected_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_truncated_masked_secret_rejected_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
...
#[test]
fn concat_kdf_tampered_masked_secret_rejected_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let mut ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_var_hmac512_min_length_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_var_hmac512_max_length_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_var_hmac512_below_min_length_rejected_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_var_hmac512_above_max_length_rejected_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
...
#[test]
fn concat_kdf_empty_masked_secret_rejected_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
...
#[test]
fn concat_kdf_fixed_key_type_ignores_explicit_length_emu() {
    let ctx = TestCtx::new();
    let session = finalized_co_session(&ctx);
    let ikm = fresh_masked_secret(&ctx, session.session_id);
