...
// Bounds for a 48-byte BK3 in an AesCbc256Hmac384 masked-key envelope. The
// firmware and simulator encode different optional metadata fields, so their
// valid MOBK lengths differ.
#[allow(dead_code)]
pub(crate) const MIN_MASKED_BK3_LEN: usize = 200;

#[allow(dead_code)]
pub(crate) const MAX_MASKED_BK3_LEN: usize = 300;
