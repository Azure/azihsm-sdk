...
#[test]
fn test_kbkdf_derive_aesbulk256_with_rollback_error() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
...
#[test]
fn test_kbkdf_derive_aesbulk256_with_rollback_after_exhaust_keys() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, ddi, path, session_id| {
...
#[test]
fn test_kbkdf_derive_aesbulk256_with_rollback_error_after_dma_out() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, ddi, path, session_id| {
...
#[test]
fn test_kbkdf_derive_aesbulk256_with_rollback_error_after_dma_out_after_exhaust_keys() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, ddi, path, session_id| {
...
#[test]
fn test_kbkdf_derive_aesbulk256_with_rollback_error_after_dma_end() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, ddi, path, session_id| {
...
#[test]
fn test_kbkdf_derive_aesbulk256_with_rollback_error_after_dma_end_after_exhaust_keys() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, ddi, path, session_id| {
