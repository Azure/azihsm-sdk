...
fn trigger_itcm_ecc_error() {
    ddi_dev_test(
        ...
        |dev, _ddi, _path, session_id| {
            ...
            let ecc_error_info = DdiTestActionEccErrorInfo {
                ecc_error_type: DdiTestActionEccErrorType::ItcmDoubleBit,
                cpu_id: DdiTestActionSocCpuId::Hsm, // cpu_id unused for ITCM error injection because only CP0 has ITCM error injection mechanism
            };
