...
static azihsm_error generate_ecc_keypair(azihsm_handle session, azihsm_ecc_curve curve, bool session_key,
                                         azihsm_handle *priv_key_handle, azihsm_handle *pub_key_handle)
{
    ...
    priv_props.push_back({AZIHSM_KEY_PROP_ID_SESSION, &session_key_flag, sizeof(session_key_flag)});
    ...
    pub_props.push_back({AZIHSM_KEY_PROP_ID_SESSION, &session_key_flag, sizeof(session_key_flag)});
