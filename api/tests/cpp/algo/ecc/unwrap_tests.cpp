...
// Helper: removes the first property with the given ID from a key property vector.
static void remove_key_prop(std::vector<azihsm_key_prop> &props, azihsm_key_prop_id prop_id)
{
    auto it = std::find_if(props.begin(), props.end(), [&](const azihsm_key_prop &prop) {
        return prop.id == prop_id;
    });
...
// Verifies unwrap rejects a private property list whose props pointer is null
// while count is non-zero.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_private_prop_list_null_props_nonzero_count)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
        ...
        priv_prop_list.props = nullptr;
        priv_prop_list.count = 1;
...
// Verifies unwrap rejects a public property list whose props pointer is null
// while count is non-zero.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_public_prop_list_null_props_nonzero_count)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
        ...
        pub_prop_list.props = nullptr;
        pub_prop_list.count = 1;
...
// Verifies unwrap rejects an empty private property list.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_empty_private_prop_list)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
...
// Verifies unwrap rejects an empty public property list.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_empty_public_prop_list)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
...
// Verifies unwrap rejects private properties missing CLASS.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_missing_private_class_property)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
        ...
        remove_key_prop(ctx.priv_props.props, AZIHSM_KEY_PROP_ID_CLASS);
...
// Verifies unwrap rejects public properties missing CLASS.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_missing_public_class_property)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
        ...
        remove_key_prop(ctx.pub_props.props, AZIHSM_KEY_PROP_ID_CLASS);
...
// Verifies unwrap rejects private properties missing KIND.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_missing_private_kind_property)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
        ...
        remove_key_prop(ctx.priv_props.props, AZIHSM_KEY_PROP_ID_KIND);
...
// Verifies unwrap rejects public properties missing KIND.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_missing_public_kind_property)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
        ...
        remove_key_prop(ctx.pub_props.props, AZIHSM_KEY_PROP_ID_KIND);
...
// Verifies unwrap rejects private properties missing EC_CURVE.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_missing_private_curve_property)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
        ...
        remove_key_prop(ctx.priv_props.props, AZIHSM_KEY_PROP_ID_EC_CURVE);
...
// Verifies unwrap rejects public properties missing EC_CURVE.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_missing_public_curve_property)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
        ...
        remove_key_prop(ctx.pub_props.props, AZIHSM_KEY_PROP_ID_EC_CURVE);
...
// Verifies unwrap rejects private/public curve mismatch.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_mismatched_private_public_curve_properties)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
...
// Verifies unwrap rejects private properties that declare a public key class.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_private_props_declaring_public_class)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
...
// Verifies unwrap rejects public properties that declare a private key class.
TEST_F(azihsm_ecc_keyunwrap, unwrap_pair_rejects_public_props_declaring_private_class)
{
    part_list_.for_each_session([](azihsm_handle session) {
        RsaAesUnwrapPairInputs unwrap_inputs(0xA5);
        UnwrapPairContext ctx;
