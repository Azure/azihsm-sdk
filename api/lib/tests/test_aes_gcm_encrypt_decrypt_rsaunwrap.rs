...
/// buffer
#[test]
fn test_aes_gcm_encrypt_decrypt_rsaunwrap() {
...
#[test]
fn test_aes_gcm_tampered_data_rsaunwrap() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_aes_gcm_encrypt_decrypt_multi_times_rsaunwrap() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_aes_gcm_encrypt_data_size_rsaunwrap() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_aes_gcm_decrypt_data_size_rsaunwrap() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_aes_gcm_mismatched_iv_rsaunwrap() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_aes_fpgcm_decrypt_invalid_mismatched_tag_rsaunwrap() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
