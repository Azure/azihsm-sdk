...
#[test]
fn test_eccgen_ecc256_sign_verify() {
...
#[test]
fn test_eccgen_ecc256_sign_verify_tampered_digestdata() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc256_sign_verify_tampered_sig() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc256_sign_verify_multi_times() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc256_sign_different_data_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc256_verify_invalid_digest_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc256_verify_invalid_sig_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc384_sign_verify_tampered_digestdata() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc384_sign_verify_tampered_sig() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc384_sign_verify_multi_times() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc384_sign_different_data_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc384_verify_invalid_digest_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc384_verify_invalid_sig_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc521_sign_verify_tampered_digestdata() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc521_sign_verify_tampered_sig() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc521_sign_verify_multi_times() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc521_sign_different_data_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc521_verify_invalid_digest_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_eccgen_ecc521_verify_invalid_sig_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
