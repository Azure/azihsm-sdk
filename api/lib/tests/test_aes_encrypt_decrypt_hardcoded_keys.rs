...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes128_import_key_encrypt_decrypt_tampered_encrypted_data() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes128_import_key_encrypt_decrypt_multi_times() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes128_import_key_encrypt_decrypt_keysize_type_mismatch() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
        ...
        let aes_key = generate_aes(KeyType::Aes192);
        let result = app_session.import_key(
            aes_key.to_vec(),
            KeyClass::Aes,
            None,
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes128_import_key_encrypt_data_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes128_import_key_decrypt_data_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes192_import_key_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes192_import_key_encrypt_decrypt_tampered_encrypted_data() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes192_import_key_encrypt_decrypt_multi_times() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes192_import_key_encrypt_data_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes192_import_key_decrypt_data_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes192_import_key_encrypt_decrypt_keysize_type_mismatch() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes256_import_key_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes256_import_key_encrypt_decrypt_tampered_encrypted_data() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes256_import_key_encrypt_decrypt_multi_times() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes256_import_key_encrypt_data_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes256_import_key_decrypt_data_size() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_aes256_import_key_encrypt_decrypt_keysize_type_mismatch() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
