...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_256_exchange_hardcodedkey_aes256_encrypt_decrypt() {
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_256_exchange_hardcodedkey_aes128_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_256_exchange_hardcodedkey_aes192_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_384_exchange_hardcodedkey_aes256_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_384_exchange_hardcodedkey_aes128_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_384_exchange_hardcodedkey_aes192_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_521_exchange_hardcodedkey_aes256_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_521_exchange_hardcodedkey_aes128_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_521_exchange_hardcodedkey_aes192_encrypt_decrypt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
