...
/// buffer
#[test]
fn test_aes_gcm_encrypt_decrypt_no_aad() {
...
#[test]
fn test_aes_gcm_zero_length_no_aad() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
/// decryption
#[test]
fn test_aes_gcm_corrupt_no_aad() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
///
#[test]
fn test_aes_invalid_key_no_aad() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_aes_gcm_mismatched_iv_no_aad() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
