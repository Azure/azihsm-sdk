...
#[test]
fn test_hkdf_derive_after_session_close() {
    api_test(common_setup, common_cleanup, |device, _path| {
...
#[test]
fn test_hkdf_derive_nonsecret_key() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_hkdf_derive_invalid_target_type() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_hkdf_derive_invalid_target_keyusage() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_hkdf_derive_non_matching_key_type() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_hkdf_derive_non_matching_keyavailability() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_hkdf_derive_non_matching_salt() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
        ...
        let params1 = HkdfDeriveParameters {
            hash_algorithm: DigestKind::Sha256,
            salt: Some(salt_bytes),
            info: Some(info_bytes),
        };
        ...
        //non matching salt
        let salt_bytes = "salt1".as_bytes();
        let info_bytes = "label".as_bytes();

        let params2 = HkdfDeriveParameters {
            hash_algorithm: DigestKind::Sha256,
            salt: Some(salt_bytes),
            info: Some(info_bytes),
        };
...
#[test]
fn test_hkdf_derive_non_matching_info() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
        ...
        //non matching info/label
        let salt_bytes = "salt".as_bytes();
        let info_bytes = "label1".as_bytes();
...
#[test]
fn test_hkdf_derive_non_matching_hash() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
        ...
        //non matching hash algorithm
        let salt_bytes = "salt".as_bytes();
        let info_bytes = "label".as_bytes();

        let params2 = HkdfDeriveParameters {
            hash_algorithm: DigestKind::Sha512,
            salt: Some(salt_bytes),
            info: Some(info_bytes),
        };
...
#[test]
fn test_hkdf_derive_multiple_times() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_key_exchange_encode_hkdf_decode_kbkdf() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
        ...
        // Use KBKDF to derive an AES key from each HKDF secret
