...
fn test_ecdh_key_exchange_hardcodedkey_eccgen() {
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_exchange_hardcodedkey_unwrappingkey() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_exchange_eccgen_hardcodedkey() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_exchange_unwrappingkey_hardcodedkey() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_ecdh_key_exchange_eccgen_unwrapping() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
fn test_ecdh_key_exchange_unwrapping_eccgen() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
...
#[test]
#[cfg(feature = "testhooks")]
fn test_ecdh_key_exchange_mixed_threekeys() {
    api_test(common_setup, common_cleanup, |device, _path| {
        let app_session = common_open_app_session(device);
