    ...
    ddi_dev_test(
        ...
        |dev, _ddi, _path, session_id| {
            let (_key_id_rsa3k_pub, key_id_rsa3k_priv) =
                store_rsa_keys_no_crt(dev, session_id, DdiKeyUsage::EncryptDecrypt, 3);
...
#[test]
fn test_rsa_3k_decrypt_incorrect_message_zero_data() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, _ddi, _path, session_id| {
            ...
            if device_kind != DdiDeviceKind::Physical {
                tracing::debug!(
                    "Skipped test_rsa_3k_decrypt_incorrect_message_zero_data for virtual device"
                );
                return;
            }
...
#[test]
fn test_rsa_3k_decrypt_incorrect_message_large_data() {
    ddi_dev_test(
        common_setup,
        common_cleanup,
        |dev, _ddi, _path, session_id| {
            ...
            if device_kind != DdiDeviceKind::Physical {
                tracing::debug!(
                    "Skipped test_rsa_3k_decrypt_incorrect_message_large_data for virtual device"
                );
                return;
            }
