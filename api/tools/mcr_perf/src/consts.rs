...
pub(crate) const TEST_BK3: [u8; 48] = [
    0x1f, 0x2e, 0x3d, 0x4c, 0x5b, 0x6a, 0x79, 0x88, 0x97, 0xa6, 0xb5, 0xc4, 0xd3, 0xe2, 0xf1, 0x00,
    0x10, 0x21, 0x32, 0x43, 0x54, 0x65, 0x76, 0x87, 0x98, 0xa9, 0xba, 0xcb, 0xdc, 0xed, 0xfe, 0x0f,
    0x1e, 0x2d, 0x3c, 0x4b, 0x5a, 0x69, 0x78, 0x87, 0x96, 0xa5, 0xb4, 0xc3, 0xd2, 0xe1, 0xf0, 0xff,
];
...
pub(crate) const TEST_ECC_256_PUBLIC_KEY_LEN: usize = 91;
pub(crate) const TEST_ECC_256_PUBLIC_KEY_DATA: [u8; 192] = [
    ...
    0x3e, 0x79, 0x41, 0xc1, 0x20, 0xf1, 0x56, 0x23, 0x0f, 0x51, 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00,
...
pub(crate) const TEST_ECC_384_PUBLIC_KEY_LEN: usize = 120;
pub(crate) const TEST_ECC_384_PUBLIC_KEY_DATA: [u8; 192] = [
    ...
    0x10, 0x07, 0xf7, 0x0e, 0xc7, 0x62, 0x42, 0xe0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
...
pub(crate) const TEST_ECC_521_PUBLIC_KEY_LEN: usize = 158;
pub(crate) const TEST_ECC_521_PUBLIC_KEY_DATA: [u8; 192] = [
    ...
    0xd0, 0x7e, 0x19, 0x82, 0xfe, 0x53, 0x30, 0x39, 0x3e, 0xe0, 0xaa, 0x75, 0x95, 0xe7, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
];

pub(crate) const KEY_TAG_ECC_SIGN_256: u16 = 0x0001;
pub(crate) const KEY_TAG_ECC_SIGN_384: u16 = 0x0002;
pub(crate) const KEY_TAG_ECC_SIGN_521: u16 = 0x6677;
pub(crate) const KEY_TAG_RSA_MOD_EXP_2K: u16 = 0x0003;
pub(crate) const KEY_TAG_RSA_MOD_EXP_3K: u16 = 0x0004;
pub(crate) const KEY_TAG_RSA_MOD_EXP_4K: u16 = 0x0005;
pub(crate) const KEY_TAG_RSA_MOD_EXP_CRT_2K: u16 = 0x0006;
pub(crate) const KEY_TAG_RSA_MOD_EXP_CRT_3K: u16 = 0x0007;
pub(crate) const KEY_TAG_RSA_MOD_EXP_CRT_4K: u16 = 0x0008;
pub(crate) const KEY_TAG_AES_CBC_128: u16 = 0x0009;
pub(crate) const KEY_TAG_AES_CBC_192: u16 = 0x000A;
pub(crate) const KEY_TAG_AES_CBC_256: u16 = 0x000B;
pub(crate) const KEY_TAG_AES_XTS_BULK_256: u16 = 0x000C;
pub(crate) const KEY_TAG_AES_XTS_BULK_256_2: u16 = 0x000D;
pub(crate) const KEY_TAG_AES_GCM_BULK_256: u16 = 0x000E;
pub(crate) const KEY_TAG_ECC_DERIVE_256: u16 = 0x0010;
pub(crate) const KEY_TAG_ECC_DERIVE_384: u16 = 0x0011;
pub(crate) const KEY_TAG_ECC_DERIVE_521: u16 = 0xed12;
pub(crate) const KEY_TAG_SECRET_256: u16 = 0x0013;
pub(crate) const KEY_TAG_SECRET_384: u16 = 0x0014;
pub(crate) const KEY_TAG_SECRET_521: u16 = 0x0015;
