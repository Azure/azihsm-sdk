...
pub(crate) mod opcode {
    ...
    /// P-384 ECC keypair for ECDH) under the active session's
    /// partition; persist the private half in the vault and return its
    /// `key_handle` plus the public key.  See
    /// [`super::sd_sealing_key_gen`].
