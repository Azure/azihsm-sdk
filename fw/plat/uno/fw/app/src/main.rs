...
///
/// # Parameters
/// - `_info`: Panic metadata provided by core (currently unused).
///
/// # Returns
/// Never returns (`!`).
///
/// # Side Effects
/// - Writes panic text to UART for early diagnostic visibility.
/// - Halts forward progress by looping forever.
#[panic_handler]
